...
$(document).ready( function () {
  ...
  $('#tabela').DataTable({
    ...
    "ajax": {
      "url": "<?php echo AJAX; ?>formapagamento.php?acao=buscar",
      "type": "GET"
    },
    "language": {
  ...
  $('#formCadastrar').validate({
    ...
    messages: {
      ...
      parcelas : { required: 'Preencha este campo'},
    },
    submitHandler: function( form ){
      var dados = $('#formCadastrar').serialize();
      $.ajax({
        type: "GET",
        url: "<?php echo AJAX; ?>formapagamento.php?acao=cadastrar",
        data: dados,
        dataType: 'json',
    ...
    $(document).on("click",".btnedit",function(){
      ...
      $.ajax({
        url : "<?php echo AJAX; ?>formapagamento.php?acao=buscarDados",
        type: "GET",
        data : value,
        success: function(data, textStatus, jqXHR){
          var data = jQuery.parseJSON(data);
          $("#nomeEdit").val(data.nome);
          $("#parcelasEdit").val(data.parcelas);
          $("#idObj").val(data.id);
    ...
    $('#formCadastrarEdit').validate({
      ...
      submitHandler: function( form ){
        ...
        $.ajax({
          type: "GET",
          url: "<?php echo AJAX; ?>formapagamento.php?acao=editar",
          data: dados,
          dataType: 'json',
          crossDomain: false,
          success: function(res) {
     ...
     $(document).on( "click",".btndel", function() {
      ...
      swal({   
        ...
        closeOnConfirm: true}).then(function(){   
          $.ajax({
          type: "GET",
          url: "<?php echo AJAX; ?>formapagamento.php",
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Forma Pagamento</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5>Gerenciar Formas de Pagamentos</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb20 col-sm-12 text-center">
                          <button type="submit" class="btn btn-raised  btn-success" id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Adicionar Forma de Pagamento</button>
                        </div>
                        <div class="col-md-6">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label>Parcelas</label>
              <input type="text" class="form-control" name="parcelas" id="parcelasEdit">
            </div>
