...
$(document).ready( function () {
  ...
  $('#formCadastrar').validate({
    ...
    messages: {
      ...
      quantidade : { required: 'Preencha este campo'},
    },
    submitHandler: function( form ){
      var dados = $('#formCadastrar').serialize();
      $.ajax({
        type: "GET",
        url: "<?php echo AJAX; ?>produtos.php?acao=cadastrar",
        data: dados,
        dataType: 'json',
    ...
    $('#formCadastrarEdit').validate({
      ...
      submitHandler: function( form ){
        ...
        $.ajax({
          type: "GET",
          url: "<?php echo AJAX; ?>produtos.php?acao=editar",
          data: dados,
          dataType: 'json',
          crossDomain: false,
          success: function(res) {
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" id="formCadastrar" autocomplete="off">
            ...
            <div class="form-group">
              <label>Preço</label>
              <input type="text" class="form-control preco" name="preco" id="preco">
            </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label>Quantidade</label>
              <input type="text" class="form-control" name="quantidade" id="quantidadeEdit">
            </div>
            <div class="form-group">
              <label>Preço</label>
              <input type="text" class="form-control preco" name="preco" id="precoEdit">
            </div> 
